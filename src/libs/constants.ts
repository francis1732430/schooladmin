...
export const MessageInfo = {
    ...
    MI_CENTER_NAME_IS_REQUIRED:"Center name is required.",
    MI_COORDINATES_IS_REQUIRED:"Coordinates is required.",
    MI_NEET_CENTER_ID_NOT_FOUND:"Neet center id not found.",
    MI_AWARD_ID_NOT_FOUND:"Award id not found.",
    MI_AWARD_NAME_IS_REQUIRED:"Award name is required.",
    MI_USER_ID_IS_REQUIRED:"User id is required.",
    MI_MOBILE_NUMBER_IS_REQUIRED:"Mobile number is required.",
    MI_PIN_NUMBER_IS_REQUIRED:"Pin number is required.",
    MI_COMPLAINT_ID_NOT_FOUND:"Complaint id not found.",
    MI_USER_ID_NOT_FOUND:"User id not found.",
    MI_TITLE_IS_REQUIRED:"Title is required.",
    MI_NOTICES_ID_NOT_FOUND:"Notices id not found.",
    MI_CATEGORY_NAME_IS_REQUIRED:"Category name is required.",
    MI_CATEGORY_NAME_ALREADY_EXISTS:"Category name already exists.",
    MI_CATEGORY_ID_NOT_FOUND:"Category id not found.",
    MI_BOOKS_NAME_ALREADY_EXISTS:"Books name already exists.",
    MI_BOOKS_ID_NOT_FOUND:"Books id not found.",
    MI_CATEGORY_ID_IS_REQUIRED:"Category id is required.",
};
