...
export const MessageInfo = {
    ...
    MI_CERTIFICATE_TYPE_DELETED: "Certificates deleted successfully.",
    MI_SCHEME_TYPE_DELETED: "Schemes deleted successfully.",
    MI_DOCUMENT_TYPE_DELETED: "Documents deleted successfully.",
    MI_STORE_DELETED: "Stores deleted successfully.",
    MI_USER_DELETED: "Users deleted successfully.",
    MI_MERCHANT_NOT_UPDATE: "Merchant Info could not be changed.",
    MI_MERCHANT_SCHEME_REQUIRED: "Please select merchant scheme.",
    MI_CAN_NOT_UPDATE_APPROVAL: "You can not update this approval.",
